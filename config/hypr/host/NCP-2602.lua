...
-- Source: ~/Dotfiles/config/hypr/common/look_and_feel.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("common.look_and_feel")
-- Source: ~/Dotfiles/config/hypr/common/window_rule.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("common.window_rule")
-- Source: ~/Dotfiles/config/hypr/common/window_and_workspaces.conf — convert this file to Lua and ensure it is on Lua's package.path.
require("common.window_and_workspaces")
-- Source: ~/Dotfiles/config/hypr/common/key_bindings.conf — convert this file to Lua and ensure it is on Lua's package.path.
